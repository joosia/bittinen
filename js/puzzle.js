...
|													|
| NOTE to PASI AND KARI:					|
| The puzzle pieces are hard coded but |
| not the slots. Didn't have time for  |
| the 											|
| pieces part, but later I'll refactor |
| this code and create the pieces 		|
| straight from the puzzle picture 		|
| itself by using css background and 	|
| offset. 										|
|													|
|                                      |
| © Esa-Pekka Autio                    |
